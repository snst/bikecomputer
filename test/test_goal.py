...
class TestGoal(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.gc = goal_calc.GoalCalc(self.data)

    def test_1(self):
        self.goal.target_dist_km = bike_data.SettingVal(60,0,0,True)
        self.goal.target_average_km_h = bike_data.SettingVal(30,0,0,True)
        self.data.goal.spent_time_ms = 60*60*1000
        self.data.goal.spent_distance_cm = 30*1000*100
        self.gc.calc()
    ...
    def test_2(self):
        ...
        self.goal.target_average_km_h = bike_data.SettingVal(30,0,0,True)
        self.data.goal.spent_time_ms = 60*60*1000
        self.data.goal.spent_distance_cm = 15*1000*100
        self.gc.calc()
    ...
    def test_3(self):
        ...
        self.goal.target_average_km_h = bike_data.SettingVal(30,0,0,True)
        self.data.goal.spent_time_ms = 60*60*1000
        self.data.goal.spent_distance_cm = 45*1000*100
        self.gc.calc()
    ...
    def test_3(self):
        self.goal.target_dist_km = bike_data.SettingVal(60,0,0,True)
        self.goal.target_average_km_h = bike_data.SettingVal(30,0,0,True)
        self.data.goal.spent_time_ms = 30*60*1000
        self.data.goal.spent_distance_cm = 30*1000*100
        self.gc.calc()
        self.assertEqual(30, self.goal.remaining_distance_km)
